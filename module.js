...
ui.createAccount = ' \
    <div class="card text-white bg-primary mb-3" style="max-width: 18rem;"> \
        ...
        <div class="card-body"> \
            Name<br/> \
                <input type="input" className="form-control" id="name" placeholder="Enter Your Name"><br> \
                    Email Address<br/> \
                        <input type="input" className="form-control" id="email" placeholder="Enter Your Email"><br> \
                            Password<br/> \
                                <input type="password" className="form-control" id="password" placeholder="Enter Your Password"><br> \
                                <button type="submit" id="submit" className="btn" onclick="create()">Create Account</button> \
